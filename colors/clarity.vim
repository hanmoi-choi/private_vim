...
highlight Normal         gui=NONE guifg=LightBlue2   guibg=Grey7
...
highlight StatusLine     gui=BOLD guifg=Gold2       guibg=bg
...
highlight WarningMsg     gui=BOLD guifg=Red          guibg=bg
...
highlight Visual         gui=BOLD guifg=Firebrick        guibg=Grey25
...
highlight Define         gui=NONE guifg=DarkGoldenrod2 guibg=bg
